...
> Nikita firmware is built exactly like Unleashed — same `fbt`, same targets.
> The version header is generated from git, so build from a git working copy.
...
```shell
$ git clone --recursive https://github.com/andresnalegre/nikita-firmware.git
```
