...
static void draw_callback(Canvas* canvas, void* _ctx) {
    ...
    default: {
        ...
        canvas_draw_icon(canvas, 119, 6, &I_bs_arrow_up_3x5);
        canvas_draw_icon(canvas, 119, 10, &I_bs_arrow_down_3x5);
    ...
    if(state->lock_warning) {
        ...
        canvas_draw_icon(canvas, 65, 42, &I_bs_back_arrow_10x8);
        canvas_draw_icon(canvas, 80, 42, &I_bs_back_arrow_10x8);
        canvas_draw_icon(canvas, 95, 42, &I_bs_back_arrow_10x8);
        canvas_draw_icon(canvas, 16, 13, &I_bs_warn_45x42);
