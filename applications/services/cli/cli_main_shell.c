...
void cli_main_motd(void* context) {
    UNUSED(context);
    printf(ANSI_NIKITA_BRAND_MAGENTA
           "\r\n"
           "              _.-------.._                    -,\r\n"
           "          .-\"```\"--..,,_/ /`-,               -,  \\ \r\n"
           "       .:\"          /:/  /'\\  \\     ,_...,  `. |  |\r\n"
           ...
           "  |    `-...|        -.___-Z:_______J...---;\r\n"
           "  :         `                           _-'\r\n"
           " _  _  ___  _  __ ___  _____    _        ___  _     ___ \r\n"
           "| \\| ||_ _|| |/ /|_ _||_   _|  /_\\      / __|| |   |_ _|\r\n"
           "| .` | | | | ' <  | |   | |   / _ \\    | (__ | |__  | | \r\n"
           "|_|\\_||___||_|\\_\\|___|  |_|  /_/ \\_\\    \\___||____||___|\r\n"
           "\r\n" ANSI_FG_BR_WHITE "Welcome to Nikita-V8, the Flipper Zero command line.\r\n"
           "Read the manual: https://docs.flipper.net/zero/development/cli\r\n"
           "Run `help` or `?` to list available commands, `nikita` for this\r\n"
           "firmware's own.\r\n"
           "\r\n" ANSI_RESET);
