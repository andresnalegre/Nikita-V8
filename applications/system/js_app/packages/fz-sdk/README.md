# Flipper Nikita FW JavaScript SDK
This package contains tooling and typings for developing Flipper Zero
applications in JavaScript for Nikita Firmware (based on official SDK).

This is a fork of the [Official Flipper Zero JS SDK](https://www.npmjs.com/package/@flipperdevices/fz-sdk),
with added types for the extra features provided by the Nikita firmware JavaScript API.

Scripts made for Official Flipper Zero JS SDK will work on Nikita Firmware too.
If you use extra features provided by Nikita FW JS SDK, you are encouraged to use syntax like
