...
static void bt_hid_connection_status_changed_callback(BtStatus status, void* context) {
    ...
    hid_parasite_set_connected_status(hid->hid_parasite, connected);
...
Hid* hid_alloc() {
    ...
    // Parasite view
    app->hid_parasite = hid_parasite_alloc(app);
    view_dispatcher_add_view(
        app->view_dispatcher, HidViewParasite, hid_parasite_get_view(app->hid_parasite));
...
void hid_free(Hid* app) {
    ...
    view_dispatcher_remove_view(app->view_dispatcher, HidViewParasite);
    hid_parasite_free(app->hid_parasite);
