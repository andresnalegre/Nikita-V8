...
static DialogMessageButton nikita_info_screen(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;

    const char* screen_header = "Nikita-V8\n";
...
static DialogMessageButton nikita_info_screen2(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;

    const char* screen_text =
        "Built on Unleashed, free and\ndistributed under\nthe OpenSource license.\n"
...
static DialogMessageButton nikita_info_screen3(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;

    const char* screen_text = "Nikita reaches this device\nfrom the phone, the desktop\n"
                              "app and the CLI. On device:\ntype `nikita` in the shell.";
